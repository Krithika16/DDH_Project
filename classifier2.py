...
def Classify2():    #again specifiy the function to be 2 and hence refere to the alpha angle
  ...
  # Training Parameters
  epochs = 50 #going through the dataset 50 times
...
#  NUM_FEATURES = 1000 #This is the number of nodes in the last layer of Marta's network
  ...
  checkpoint = ModelCheckpoint("results/tf2/saveweights/best_model"+file_time+".hdf5", monitor = 'val_binary_accuracy', verbose=1, save_best_only=True, save_weights_only = True, mode='max', save_freq='epoch')
